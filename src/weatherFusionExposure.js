...
export const EXPOSURE_VERSION='comfort-paws-uv-v1';
...
export function exposureWeatherUrl(location,zone='America/New_York'){
 return 'https://api.open-meteo.com/v1/forecast?'+new URLSearchParams({
  ...
  hourly:'temperature_2m,dew_point_2m,relative_humidity_2m,wind_speed_10m,cloud_cover,shortwave_radiation_instant,precipitation',
...
export function addExposureWeather(out,exposureWeather){
 ...
 out.uv={source:'Open-Meteo',url:'https://open-meteo.com/en/docs',kind:'Forecast daily maximum',today:out.days[0]?.uvMax??null};
 return out;
}
