...
.fiq-intro{min-height:286px;margin:0!important;padding:46px 0 42px!important;color:#d9e7f2!important;display:flex;flex-direction:column;justify-content:center}.fiq-kicker{display:block;color:#8fc4ea;text-transform:uppercase;letter-spacing:.18em;font-size:12px;font-weight:900}.fiq-intro h1{max-width:1180px;margin:12px 0 16px;color:#fff;font-size:clamp(44px,5vw,74px);line-height:.98;letter-spacing:-.05em}.fiq-intro>p{max-width:1100px;margin:0;color:#c8dae7;font-size:clamp(17px,1.4vw,21px);line-height:1.55}.fiq-intro .aadt-tabs{margin:27px 0 0;display:flex;align-items:center;gap:9px;flex-wrap:wrap}.fiq-intro .aadt-tabs .muted{color:#87a1b5;font-size:13px}.fiq-intro .aadt-tab{display:inline-flex;align-items:center;justify-content:center;min-width:48px;padding:10px 14px;border:1px solid rgba(255,255,255,.18);border-radius:999px;background:rgba(255,255,255,.07);color:#fff;text-decoration:none;font-size:13px;font-weight:850}.fiq-intro .aadt-tab:hover{background:rgba(255,255,255,.14)}
