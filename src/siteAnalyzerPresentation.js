...
.fiq-topbar{min-height:72px;display:flex!important;align-items:center!important;justify-content:space-between;gap:18px;margin:0!important;color:#fff}.fiq-brand{display:flex;align-items:center;gap:11px;color:#fff;text-decoration:none}.fiq-brand-mark{width:38px;height:38px;border-radius:11px;display:grid;place-items:center;background:linear-gradient(145deg,var(--fiq-gold),#ffda7a);color:var(--fiq-ink);font-size:12px;font-weight:900;box-shadow:0 8px 24px rgba(244,185,66,.2)}.fiq-brand-copy{display:grid;line-height:1.08}.fiq-brand-copy strong{font-size:17px}.fiq-brand-copy small{margin-top:3px;color:#9eb6c8;font-size:11px;font-weight:800;letter-spacing:.04em;text-transform:uppercase}.fiq-top-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end}.fiq-top-actions a{padding:9px 12px;border:1px solid rgba(255,255,255,.18);border-radius:9px;background:rgba(255,255,255,.07);color:#e5f0f8;text-decoration:none;font-size:12px;font-weight:800}.fiq-top-actions a:hover{background:rgba(255,255,255,.14)}.fiq-top-actions .fiq-primary-link{border-color:var(--fiq-gold);background:var(--fiq-gold);color:var(--fiq-ink)}
.fiq-intro{min-height:225px;margin:0!important;padding:30px 0 36px!important;color:#d9e7f2!important}.fiq-kicker{display:block;color:#8fc4ea;text-transform:uppercase;letter-spacing:.17em;font-size:11px;font-weight:900}.fiq-intro h1{max-width:980px;margin:10px 0 12px;color:#fff;font-size:clamp(34px,4vw,58px);line-height:1;letter-spacing:-.045em}.fiq-intro>p{max-width:980px;margin:0;color:#c8dae7;font-size:16px;line-height:1.55}.fiq-intro .aadt-tabs{margin:22px 0 0;display:flex;align-items:center;gap:8px;flex-wrap:wrap}.fiq-intro .aadt-tabs .muted{color:#87a1b5}.fiq-intro .aadt-tab{display:inline-flex;align-items:center;justify-content:center;min-width:45px;padding:9px 12px;border:1px solid rgba(255,255,255,.18);border-radius:999px;background:rgba(255,255,255,.07);color:#fff;text-decoration:none;font-size:12px;font-weight:850}.fiq-intro .aadt-tab:hover{background:rgba(255,255,255,.14)}
...
#aadtChoiceCard:not(.fiq-positioned),#siteResearchCard:not(.fiq-positioned){display:none!important}.aadt-choice-panel{display:none;margin-top:20px;padding-top:19px;border-top:1px solid var(--fiq-line)}.aadt-choice-panel.is-ready{display:block}.aadt-choice-panel .aadt-choice-list{grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.fiq-professional-layout .aadt-choice{min-height:108px;color:var(--fiq-ink)!important;background:#fbfdff!important;border-color:var(--fiq-line)!important}.fiq-professional-layout .aadt-choice:has(input:checked){background:#eef7fc!important;border-color:var(--fiq-blue2)!important}.fiq-professional-layout .aadt-choice .meta{color:#627484!important}
.research-options-panel{margin-top:20px;padding-top:19px;border-top:1px solid var(--fiq-line)}.research-options-panel .research-head{display:flex;align-items:flex-start;justify-content:space-between;gap:14px;flex-wrap:wrap}.research-options-panel .research-head b{font-size:16px}.research-options-panel .research-actions{display:flex;gap:7px}.research-options-panel .research-actions button{padding:7px 10px!important;border:1px solid var(--fiq-line)!important;border-radius:8px!important;background:#fff!important;color:#31516a!important;font-size:11px!important;font-weight:800!important}.research-options-panel .site-research-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:9px;margin-top:14px}.research-options-panel .site-research-grid .chip{min-height:44px;padding:10px 11px;border:1px solid var(--fiq-line);border-radius:10px;background:#fbfdff;color:#29475d;line-height:1.3}.research-options-panel .site-research-grid .chip:has(input:checked){border-color:#8bb8d7;background:#eef7fc}.research-options-panel .property-record-note{margin:13px 0 0!important;padding:11px 12px!important;border:1px solid #ead084!important;border-radius:10px!important;background:#fff8e6!important;color:#6b4d00!important;font-size:12px;line-height:1.45}.research-feedback-row{display:grid;gap:8px;margin-top:13px}.research-feedback-row progress{width:100%!important;height:8px!important;accent-color:var(--fiq-blue2)}#siteResearchStatus{margin:0!important;min-height:18px;color:#526678!important;font-size:12px!important;line-height:1.45}#siteResearchWord.fiq-export-source{display:none!important}
...
@media(max-width:800px){body.fiq-professional-layout{background:linear-gradient(180deg,#071522 0 405px,var(--fiq-soft) 405px 100%);padding-bottom:176px!important}.fiq-topbar{padding:14px 0;align-items:flex-start;flex-wrap:wrap}.fiq-top-actions{width:100%;justify-content:flex-start;margin-left:49px}.fiq-intro{min-height:245px;padding-top:16px!important}.research-options-panel .site-research-grid,.aadt-choice-panel .aadt-choice-list{grid-template-columns:repeat(2,minmax(0,1fr))}.fiq-section-heading,.fiq-export-dock-inner{align-items:flex-start;flex-direction:column}.fiq-export-actions{justify-content:flex-start}.expected-gallons-grid{grid-template-columns:repeat(2,1fr)}}
@media(max-width:620px){body.fiq-professional-layout .wrap{width:min(100% - 18px,1460px)}body.fiq-professional-layout .row.input-row{grid-template-columns:1fr}.input-row>div:first-child,.analysis-action-stack{grid-column:span 1}.fiq-top-actions{margin-left:0}.fiq-intro h1{font-size:34px}.fiq-professional-layout .card{padding:16px;border-radius:14px}.research-options-panel .site-research-grid,.aadt-choice-panel .aadt-choice-list{grid-template-columns:1fr}.fiq-export-actions{width:100%;display:grid;grid-template-columns:1fr}.fiq-export-actions button{width:100%}.expected-gallons-grid{grid-template-columns:1fr}.fiq-results-card #siteResearchResults{padding:12px!important}.fiq-research-loading p{font-size:15px}}
</style>`;
...
<section class="instructions fiq-intro">
  <span class="fiq-kicker">Fuel site underwriting</span>
  <h1>Estimate volume, validate traffic, and run sourced diligence in one workflow.</h1>
  <p>Select an address, review the recommended official AADT reading, run the estimate, and use exhaustive research for public records, ratings, development activity, competition, and market diligence.</p>
  ${quickLinks}
</section>`);
