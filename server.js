...
/* ───────────────────────────── Config / ENV ───────────────────────────── */
const UA = "FuelEstimator/3.2 (+you@example.com)";
...
function gallonsWithRules({ aadt, mpds, diesel, compCount, heavyCount, pricePosition, userExtrasMult=1 }){
  ...
  // Extras; never exceed baseline ceiling
...
app.post("/estimate", async (req,res)=>{
  try{
    ...
    // Competitors: fetch 3 mi, subset 1.5 mi
    ...
    // Developments (always try everything)
