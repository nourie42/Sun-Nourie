...
test('production integration and cache-busting cover every new component',()=>{
 ...
 assert.match(html,/Dan's take/);assert.match(html,/Current temperature/);assert.match(html,/Because Apple, Google and Samsung weather suck/);assert.match(html,/personal-details\.css\?v=location-models-paw-warning-v5/);
