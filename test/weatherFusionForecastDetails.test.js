...
test('changed assets are cache-busted and late briefing responses stay guarded',()=>{
 assert.match(html,/forecast-layout\.css\?v=weather-art-labels-v10/);assert.match(html,/app\.js\?v=scenario-weather-v29/);assert.match(html,/forecast-cards\.css\?v=unified-weather-v24/);assert.match(html,/scenario-layout\.css\?v=scenario-weather-v29/);
