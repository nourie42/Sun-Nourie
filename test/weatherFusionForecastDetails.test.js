...
test('changed assets are cache-busted and late briefing responses stay guarded',()=>{
 assert.match(html,/forecast-layout\.css\?v=weather-art-labels-v10/);assert.match(html,/app\.js\?v=experimental-car-wash-v39/);assert.match(html,/car-wash\.css\?v=car-wash-v39/);assert.match(html,/forecast-cards\.css\?v=hrrr-rain-signal-v27/);assert.match(html,/scenario-layout\.css\?v=scenario-weather-v29/);
 assert.match(app,/dans-take\.js\?v=weather-art-labels-v10/);
 assert.match(app,/experience\.js\?v=consistent-rain-scenes-v36/);
 assert.match(app,/forecast-story\.js\?v=forecast-story-v39/);
 assert.match(app,/car-wash\.js\?v=car-wash-v39/);
