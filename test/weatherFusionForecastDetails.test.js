...
test('changed assets are cache-busted and late briefing responses stay guarded',()=>{
 assert.match(html,/style\.css\?v=car-wash-icon-back-v46/);assert.match(html,/forecast-layout\.css\?v=weather-art-labels-v10/);assert.match(html,/personal-details\.css\?v=wpc-mpd-v12/);assert.match(html,/app\.js\?v=qpf-trace-v62/);assert.match(html,/car-wash\.css\?v=rain-consensus-v41/);assert.match(html,/forecast-cards\.css\?v=remainder-today-v42/);assert.match(html,/scenario-layout\.css\?v=scenario-weather-v29/);
 assert.match(app,/dans-take\.js\?v=weather-art-labels-v10/);
 assert.match(app,/bulletins\.js\?v=wpc-mpd-v1/);
 assert.match(app,/experience\.js\?v=qpf-trace-v53/);
 assert.match(app,/personal-details\.js\?v=comfort-rain-v38/);
 assert.match(app,/forecast-story\.js\?v=forecast-trace-v40/);
 assert.match(app,/weather-display\.js\?v=qpf-trace-v53/);assert.match(app,/current-temperature\.js\?v=radar-dry-v48/);assert.match(app,/car-wash\.js\?v=qpf-trace-v48/);
