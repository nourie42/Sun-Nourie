...
test('changed assets are cache-busted and late briefing responses stay guarded',()=>{
 assert.match(html,/style\.css\?v=car-wash-icon-back-v46/);assert.match(html,/forecast-layout\.css\?v=weather-qa-v67/);assert.match(html,/personal-details\.css\?v=wpc-mpd-v12/);assert.match(html,/app\.js\?v=weather-qa-v67/);assert.match(html,/car-wash\.css\?v=rain-consensus-v41/);assert.match(html,/forecast-cards\.css\?v=weather-qa-v65/);assert.match(html,/scenario-layout\.css\?v=weather-qa-v67/);
 ...
 assert.match(app,/weather-display\.js\?v=weather-qa-v67/);assert.match(app,/current-temperature\.js\?v=rain-around-v66/);assert.match(app,/car-wash\.js\?v=weather-qa-v67/);
