...
test('large graph retains readable pixel dimensions and real time spacing',()=>{
 const points=[0,1,10].map(n=>({epoch:now+n*H,value:65+n/2}));
 const g=graphGeometry(points,240,310);assert.ok(g.W>=1200);assert.equal(g.height,300);
