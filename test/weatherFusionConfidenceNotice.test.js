...
test('daily-row and dialog notices have responsive visual treatment',()=>{
 ...
 assert.match(scenario,/@media\(max-width:760px\)[\s\S]*\.daily-panel \.forecast-confidence-notice\{display:none\}/,'phone cards stay compact; the same confidence detail remains in the day dialog and accessible label');
