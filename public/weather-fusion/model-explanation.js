...
export function modelExplanationHTML(forecast, options = {}) {
  ...
  return `<div class="model-explanation-heading"><h2 id="model-explanation-title">Why this forecast</h2><div class="model-selectors"><label>Day<select data-model-day>${choices}</select></label><label>Period<select data-model-phase>${phaseOptions}</select></label></div></div>
