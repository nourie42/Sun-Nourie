...
import {forecastGrossLevel} from './dewpoint-meter.js?v=scenario-weather-v29';
import {exposureScene} from './exposure-scene.js?v=scenario-weather-v29';
...
export function sunShadeHTML(comfort,location,now=Date.now(),context={}){
 ...
 const compactSunTitle=!daylight?'Night':['clear','partly-cloudy'].includes(kind)?'Sun':exposureTitle(condition,true,comfort?.inputEvidence?.skyCover);
