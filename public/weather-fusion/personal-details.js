...
import {exposureScene,precipitationActivity} from './exposure-scene.js?v=rain-now-v71';
...
export function sunShadeHTML(comfort,location,now=Date.now(),context={}){
 ...
 const compactSunTitle=!daylight?'Night':activeRain?'Rain':kind==='clear'?'Sun':kind==='partly-cloudy'?'Partly cloudy':kind==='cloudy'?'Mostly cloudy':kind==='fog'?'Fog':kind==='snow'?'Snow':kind==='storm'?'Storms':'Day';
