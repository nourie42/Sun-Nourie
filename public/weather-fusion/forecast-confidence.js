export const FORECAST_CONFIDENCE_VERSION='weather-nourie-confidence-v1';
...
export function forecastConfidence({dayIndex=0,highSpread=null,qpfSpread=null,guidanceCount=0,officialDay=false,officialNight=false}={}){
 ...
 factors.push(`${guidanceCount} usable model source${guidanceCount===1?'':'s'}`);
 ...
 return {version:FORECAST_CONFIDENCE_VERSION,score,label,key,factors,
