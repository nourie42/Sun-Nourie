import {finite,solarElevation,thermalHumidity} from './weather-math.js?v=weather-qa-v65';
import {clothingForFeels,referenceScene,precipitationActivity} from './exposure-scene.js?v=rain-around-v66';
import {thermalRisk} from './thermal-risk.js?v=weather-art-labels-v10';
import {weatherShapes} from './weather-display.js?v=rain-around-v66';
...
export function petSurfaceSubtitle(result){
 ...
 if(result.activePrecipitation)return 'Wet pavement · heat warning paused';
